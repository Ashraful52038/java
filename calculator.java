...
public class calculator implements ActionListener {
    ...
    JButton onOffButton; // New on/off button
    JPanel panel;

    Font myFont = new Font("Arial", Font.BOLD, 30);
    double num1 = 0, num2 = 0, result = 0;
    String operator;
    boolean isCalculatorOn = true; // Declare isCalculatorOn here
    ...
    calculator() {
        ...
        textfield.setBackground(Color.WHITE); // Set textfield background color to white
        textfield.setEditable(false);

        onOffButton = new JButton("ON/OFF");
        onOffButton.setBounds(50, 100, 300, 30);
        onOffButton.setFont(myFont);
        ...
        // Set the initial background color and opacity of the buttons
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == onOffButton) {
            ...
            if (!isCalculatorOn) {
                textfield.setText("");
                // Disable all buttons when the calculator is "off"
                for (int i = 0; i < 10; i++) {
                ...
                // Enable all buttons when the calculator is "on"
                for (int i = 0; i < 10; i++) {
        ...
        // Change the background color and opacity of the buttons when clicked
        for (JButton button : numberButtons) {
